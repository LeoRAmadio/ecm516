...
//definir um mapa de funcoes tal qual feita no consulta,
//trate o evento do tipo ObservacaoCriada
//Caso seu texto tenha a palavra importante, troque seu status,
//para importante, caso contrario, troque para comum
...
const funcoes = {
    ObservacaoCriada: async (observacao) => {
        if(observacao.texto.includes(palavraChave)) observacao.status = palavraChave
        else observacao.status = 'comum'
